...
!
!  PURPOSE   produces stage 1 of the 3-D LAS subdivision in the event that
!            one or two (but not three) of k1, k2, or k3 is equal to 1.
!
!
!  REVISION HISTORY:
!  1.2	explicitly declared dot function types (Dec 5/96)
!--------------------------------------------------------------------------
