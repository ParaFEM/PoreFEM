...
!
!  PURPOSE  creates the parameter matrices required for the edge cell
...
!							factorize R
         ...
         if( ierr .ne. 0 ) then
            write(iout,1)'Error: unable to factorize edge covariance matrix in EDGE3D.'
            stop
         endif
!							make a copy of S
         do 50 j = 1, 7
...
!							Cholesky Decomposition
         ...
         if( rerr .gt. tol ) then
            write(iout,1)'Warning: Cholesky decomposition of edge covariance matrix BB'
