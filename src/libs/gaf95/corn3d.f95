...
!							factorize R
      ...
      if( ierr .ne. 0 ) then
         write(iout,1)'Error: unable to factorize corner covariance matrix in CORN3D.'
         stop
      endif
!							for each corner...
      do 70 nc = 1, 8
...
!							Cholesky Decomposition
         ...
         if( rerr .gt. tol ) then
            write(iout,1)'Warning: Cholesky decomposition of corner covariance matrix BB'
