...
!
!  PURPOSE  prints two values according to a C style format
!
!  This routine takes as input a format, which is a character string
!  containing C style format descriptors, along with two additional
!  arguments and prints them to the given unit. For example, say you wish
!  to print the values of the variables 'i' and `d' to unit 6 so that
!  the output appears as
!
!	d(3) = 16.49
!
!  (assuming i = 3 and d = 16.49), then this routine would be
!  called as follows;
!
!	call print2( 6, 'd(%i) = %f%n', i, d )
!
...
!
!  NOTES:
!   1)	if more than 2 occurrences of the formats %f, %e or %i appear in
