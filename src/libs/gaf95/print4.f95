...
!
!  PURPOSE  prints four values according to a C style format
!
!  This routine takes as input a format, which is a character string
!  containing C style format descriptors, along with four additional
!  arguments and prints them to the given unit. For example, say you wish
!  to print the values of the variables 'i', `d', 'j', and 'f' to unit 6
!  so that the output appears as
!
!	d(3) = 16.49, f(12) = -0.03
!
!  (assuming i = 3, d = 16.49, j = 12, and f = -0.03), then this routine
!  would be called as follows;
!
!	call print4( 6, 'd(%i) = %f, f(%i) = %f%n', i, d, j, f )
!
...
!
!    val1	the first input argument. val1 can be either real or integer,
...
!
!  NOTES:
!   1)	if more than 4 occurrences of the formats %f, %e or %i appear in
!	the format string, the last argument value is repeatedly used (this may
